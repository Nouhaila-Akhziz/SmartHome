...
public class Appareilsdaoimmp implements AppareilsIDAO {

    @Override
    public Appareils find(int id) {
        Appareils appareil = null;
        try (Connection connection = SingleConnexion.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM Appareils WHERE ID = ?")) {
    ...
    public void save(Appareils appareil) {
        try (Connection connection = SingleConnexion.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO Appareils (NomAppareil, TypeAppareil, ÉtatAppareil, IDUtilisateur) VALUES (?, ?, ?, ?)")) {
    ...
    public void update(Appareils appareil) {
        try (Connection connection = SingleConnexion.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("UPDATE Appareils SET NomAppareil = ?, TypeAppareil = ?, ÉtatAppareil = ?, IDUtilisateur = ? WHERE ID = ?")) {
    ...
    public void delete(Appareils appareil) {
        try (Connection connection = SingleConnexion.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("DELETE FROM Appareils WHERE ID = ?")) {
